...
```bash
python entrenar_modelo.py --input ../Inputs/Hospitales.xlsx --output .
```
...
```bash
python predecir_nuevos.py --input ../Inputs/nuevos_pacientes.xlsx --model modelo_egreso_mejora.joblib --output predicciones.csv
```
